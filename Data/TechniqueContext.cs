...
namespace HIPS_TS.Data
{
    public partial class TechniqueContext : DbContext
    {
        ...
        public virtual DbSet<Jin>                  Jin                  { get; set; }
        public virtual DbSet<JinName>              JinName              { get; set; }
        ...
        public virtual DbSet<TypeEntity>           Type                 { get; set; }
        ...
        {
            modelBuilder.HasDefaultSchema("technique");
